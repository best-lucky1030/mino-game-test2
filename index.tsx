...
const Home: NextPage = () => {
    ...
    // update page data and components
    ...
    // cliam function from user valut
                                    ...
                                    {wallet.publicKey === null ? (
                                        ...
                                        <div className="place-bet">
                                            ...
                                            <div className="action">
                                                <button
                                                    className={`to-bet button white ${betLoading ? "load-active" : ""
                                                        }  ${userLoading ? "loading" : ""}`}
                                                    title={
